...
use App\Orchid\Screens\LogViewScreen;
...
Route::screen('all_news', NewsListScreen::class)
    ->name('platform.all_news.list');

//Logs
Route::screen('log/{log?}', LogViewScreen::class)
->name('platform.log.view');

Route::screen('logs', LogListScreen::class)
->name('platform.logs.list');
